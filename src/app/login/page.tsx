...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="flex h-screen">
        <div className="w-full text-center gap-y-2 flex flex-col justify-center">
      ...
      <Image src="/logo.svg" width={150} height={500} alt="FrutBits Logo" className="rotate-[30deg] fixed bottom-0 animate-[svg-left-waves_5s_infinite_alternate] " />
    </>
  );
}
